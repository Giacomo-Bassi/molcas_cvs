# 1 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f"
************************************************************************
...
*
      Implicit Real*8 (A-H,O-Z)
*
# 1 "/home/giacomo/src_OpenMolcas/src/mclr/cstate_mclr.fh" 1
************************************************************************
* This file is part of OpenMolcas.                                     *
*                                                                      *
* OpenMolcas is free software; you can redistribute it and/or modify   *
...
*. CSTATE
     ...
     &              NROOT,IDC,INTSEL,IALIGN,
     &              NGENSYM,IGENSYM(100),INVSYM,IKRAM
      Real*8 PSSIGN,PLSIGN, ETHRES,CTHRES
      COMMON/CSTATE_MCLR/PSSIGN,PLSIGN,IREFSM,IREFML,IREFPA,IREFL,MS2,
     &              MULTS,NROOT,IDC,INTSEL,IALIGN,
     &              ETHRES,CTHRES,NGENSYM,IGENSYM,INVSYM,IKRAM
*
*     EROOT(100),IROOT(100)
*
# 357 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
# 1 "/home/giacomo/src_OpenMolcas/src/mclr/orbinp_mclr.fh" 1
************************************************************************
* This file is part of OpenMolcas.                                     *
*                                                                      *
* OpenMolcas is free software; you can redistribute it and/or modify   *
...
# 359 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
# 1 "/home/giacomo/src_OpenMolcas/src/mclr/cicisp_mclr.fh" 1
************************************************************************
* This file is part of OpenMolcas.                                     *
*                                                                      *
* OpenMolcas is free software; you can redistribute it and/or modify   *
...
# 361 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
# 1 "/home/giacomo/src_OpenMolcas/src/mclr/Files_mclr.fh" 1
************************************************************************
* This file is part of OpenMolcas.                                     *
*                                                                      *
* OpenMolcas is free software; you can redistribute it and/or modify   *
...
*----------------------------------------------------------------------*
*
      Character*8 FnOne,FnJob,FnTwo,FnMol,
     &            FnRlx,FnMck,FnTemp,
     &            FnHlf1,FnHlf2,FNHlf3,FNHlf4,FnPT2,
     &            FNTrI1,FNTrI2,FNTRi3,FNTRI4,FNTRI5,FNCSF2SD,FnMOTRA,
     &            FnQDAT
      Integer   LuOne,LuJob,LuTwo,LuMol,
     &          LuRlx,LuMck,LuTemp,
     &          LUHLF1,LUHlf2,LUHlf3,LUHLF4,LuPt2,
     &          LUTrI1,LUTrI2,LUTRi3,LUTRI4,LUTRI5,LUCSF2SD,LuMOTRA,
     &          LuQDAT
      Logical   Nofile
      Common /Files_mclr/FnOne,FnJob,FnTwo,FnMol,
     &                   FnRlx,FnMck,FnTemp,FnPt2,
     &                   FnHlf1,FnHlf2,FNHlf3,FNHlf4,FnCSF2SD,
     &                   LuOne,LuJob,LuTwo,LuMol,
     &                   LuRlx,LuMck,LuTemp,
     &                   LUHLF1,LUHlf2,LUHlf3,LUHLF4,LuPT2,
     &                   FNTrI1,FNTrI2,FNTRi3,FNTRI4,FNTRI5,
     &                   LUTrI1,LUTrI2,LUTRi3,LUTRI4,LUTRI5,
     &                   LUCSF2SD,
     &                   Nofile, FnMOTRA, LuMOTRA, FnQDAT, LuQDAT
# 364 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
      integer idum(1)
      Integer, Allocatable:: SIOIO(:), SBLTP(:), IOOS1(:),
     &                       NOOS1(:)
*     COMMONBLOCK THE SUPPORT STORAGE OF REORDERING VECTOR
*     ON DISK
# 1 "/home/giacomo/src_OpenMolcas/src/mclr/csfsd.fh" 1
************************************************************************
* This file is part of OpenMolcas.                                     *
*                                                                      *
* OpenMolcas is free software; you can redistribute it and/or modify   *
...
# 370 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
...
*     EROOT(100),IROOT(100)
*
# 1899 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
# 1900
*
...
*    &              NBLKIC(MXPCSM,MXPICI),LCOLIC(MXPCSM,MXPICI), !  Va ae de
*    &              IR04SPC(2,MXPICI)                            !  Va ae de
# 1907 "/home/giacomo/src_OpenMolcas/src/mclr/csf.f" 2
*
*
*.Local memory
